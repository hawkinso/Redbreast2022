...
aov <- data.frame(rbind(pg.aov,tto.aov,ttc.aov,pprot.aov,pprotvel.aov,tpprot.aov,velpg.aov,maxvel.aov,tmaxvel.aov,accpg.aov,ratio.aov,vol.aov,ppd.aov,
                       time.aov,velcapture.aov,ai.aov))
aov$Stat.Designation <- rep(c("Individuals","Residuals"),length.out=32)
...
ggplot(data, aes(x=Individual, y=Gape_prop,fill=Individual)) + 
  geom_boxplot()+
theme_classic()+ 
...
ggplot(all.data, aes(x=Individual, y=TTO,fill=Individual)) + 
  geom_boxplot()+
  theme_classic()+ 
  ylim(0,70)+
  scale_fill_manual(values=park_palettes$Everglades)+
...
ggplot(all.data, aes(x=Individual, y=TTC,fill=Individual)) + 
  geom_boxplot()+
  theme_classic()+ 
  ylim(0,165)+
  scale_fill_manual(values=park_palettes$Everglades)+
...
ggplot(all.data, aes(x=Individual, y=PPROT_mag,fill=Individual)) + 
  geom_boxplot()+
  theme_classic()+ 
  ylim(0,1)+
  scale_fill_manual(values=park_palettes$Everglades)+
...
ggplot(all.data, aes(x=Individual, y=PPROTVEL_mag,fill=Individual)) + 
  geom_boxplot()+
  theme_classic()+ 
  ylim(0,70)+
  scale_fill_manual(values=park_palettes$Everglades)+
...
ggplot(all.data, aes(x=Individual, y=tPPROT,fill=Individual)) + 
  geom_boxplot()+
  theme_classic()+ 
  ylim(-50,50)+
...
ggplot(all.data, aes(x=Individual, y=VELPG_mag,fill=Individual)) + 
  geom_boxplot()+
  theme_classic()+ 
  ylim(0,80)+
  scale_fill_manual(values=park_palettes$Everglades)+
...
ggplot(all.data, aes(x=Individual, y=maxVEL_mag,fill=Individual)) + 
  geom_boxplot()+
  theme_classic()+ 
  ylim(0,120)+
  scale_fill_manual(values=park_palettes$Everglades)+
...
ggplot(all.data, aes(x=Individual, y=tmaxVEL,fill=Individual)) + 
  geom_boxplot()+
  theme_classic()+ 
  ylim(-60,60)+
  geom_hline(yintercept=0,linetype=2)+
...
ggplot(all.data, aes(x=Individual, y=ACCPG_mag,fill=Individual)) + 
  geom_boxplot()+
  theme_classic()+
  ylim(-5000,5000)+
  scale_fill_manual(values=park_palettes$Everglades)+
...
ggplot(all.data, aes(x=Individual, y=H_L_ratio,fill=Individual)) + 
  geom_boxplot()+
  theme_classic()+ 
  ylim(0,1.5)+
  scale_fill_manual(values=park_palettes$Everglades)+
...
ggplot(all.data, aes(x=Individual, y=AI,fill=Individual)) + 
  geom_boxplot()+
  theme_classic()+ 
  ylim(0,1)+
  scale_fill_manual(values=park_palettes$Everglades)+
...
ggplot(all.data, aes(x=Individual, y=ingested_volume_mag,fill=Individual)) + 
  geom_boxplot()+
  theme_classic()+ 
  ylim(0,50)+
  scale_fill_manual(values=park_palettes$Everglades)+
...
ggplot(all.data, aes(x=Individual, y=PPDiopen_mag,fill=Individual)) + # maybe scale to mouth diameter
  geom_boxplot()+
  theme_classic()+ 
  ylim(0,3)+
  scale_fill_manual(values=park_palettes$Everglades)+
...
ggplot(all.data, aes(x=Individual, y=VELpreycapture_mag,fill=Individual)) + 
  geom_boxplot()+
  theme_classic()+ 
  ylim(0,90)+
  scale_fill_manual(values=park_palettes$Everglades)+
...
ggplot(all.data, aes(x=Individual, y=timeatcapture,fill=Individual)) + 
  geom_boxplot()+
  theme_classic()+ 
  ylim(-90,90)+
  geom_hline(yintercept=0,linetype=2)+
