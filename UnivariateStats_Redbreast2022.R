...
## Repeat t tests but for each individual 

pg.t1 <-  ResTTest(all.data$PG[all.data$Individual=="LAUR01"],all.data$Strategy[all.data$Individual=="LAUR01"])
tto.t1 <- ResTTest(all.data$TTO[all.data$Individual=="LAUR01"],all.data$Strategy[all.data$Individual=="LAUR01"])
ttc.t1 <- ResTTest(all.data$TTC[all.data$Individual=="LAUR01"],all.data$Strategy[all.data$Individual=="LAUR01"])
pprot.t1 <- ResTTest(all.data$PPROT[all.data$Individual=="LAUR01"],all.data$Strategy[all.data$Individual=="LAUR01"])
pprotvel.t1 <- ResTTest(all.data$PPROTVEL[all.data$Individual=="LAUR01"],all.data$Strategy[all.data$Individual=="LAUR01"])
tpprot.t1 <- ResTTest(all.data$tPPROT[all.data$Individual=="LAUR01"],all.data$Strategy[all.data$Individual=="LAUR01"])
velpg.t1 <- ResTTest(all.data$VELPG[all.data$Individual=="LAUR01"],all.data$Strategy[all.data$Individual=="LAUR01"])
maxvel.t1 <- ResTTest(all.data$maxVEL[all.data$Individual=="LAUR01"],all.data$Strategy[all.data$Individual=="LAUR01"])
tmaxvel.t1 <- ResTTest(all.data$tmaxVEL[all.data$Individual=="LAUR01"],all.data$Strategy[all.data$Individual=="LAUR01"])
accpg.t1 <- ResTTest(all.data$ACCPG[all.data$Individual=="LAUR01"],all.data$Strategy[all.data$Individual=="LAUR01"])
ratio.t1 <- ResTTest(all.data$H_L_ratio[all.data$Individual=="LAUR01"],all.data$Strategy[all.data$Individual=="LAUR01"])
vol.t1 <- ResTTest(all.data$ingested_volume[all.data$Individual=="LAUR01"],all.data$Strategy[all.data$Individual=="LAUR01"])
ppd.t1 <- ResTTest(all.data$PPDiopen[all.data$Individual=="LAUR01"],all.data$Strategy[all.data$Individual=="LAUR01"])
time.t1 <- ResTTest(all.data$timeatcapture[all.data$Individual=="LAUR01"],all.data$Strategy[all.data$Individual=="LAUR01"])
ai.t1 <- ResTTest(all.data$AI[all.data$Individual=="LAUR01"],all.data$Strategy[all.data$Individual=="LAUR01"])

ttest1 <- data.frame(rbind(pg.t1,tto.t1,ttc.t1,pprot.t1,pprotvel.t1,tpprot.t1,velpg.t1,maxvel.t1,tmaxvel.t1,accpg.t1,ratio.t1,vol.t1,ppd.t1,
                          time.t1,ai.t1))
ttest1$Individual <- "LAUR01"
ttest1$variable <- c("PG","TTO","TTC","PPROT","PPROTVEL","tPPROT","VELPG",
                    "maxVEL","tmaxVEL","ACCPG","H:L","volume","PPDiopen",
                    "timeatcapture","AI")

pg.t2 <-  ResTTest(all.data$PG[all.data$Individual=="LAUR02"],all.data$Strategy[all.data$Individual=="LAUR02"])
tto.t2 <- ResTTest(all.data$TTO[all.data$Individual=="LAUR02"],all.data$Strategy[all.data$Individual=="LAUR02"])
ttc.t2 <- ResTTest(all.data$TTC[all.data$Individual=="LAUR02"],all.data$Strategy[all.data$Individual=="LAUR02"])
pprot.t2 <- ResTTest(all.data$PPROT[all.data$Individual=="LAUR02"],all.data$Strategy[all.data$Individual=="LAUR02"])
pprotvel.t2 <- ResTTest(all.data$PPROTVEL[all.data$Individual=="LAUR02"],all.data$Strategy[all.data$Individual=="LAUR02"])
tpprot.t2 <- ResTTest(all.data$tPPROT[all.data$Individual=="LAUR02"],all.data$Strategy[all.data$Individual=="LAUR02"])
velpg.t2 <- ResTTest(all.data$VELPG[all.data$Individual=="LAUR02"],all.data$Strategy[all.data$Individual=="LAUR02"])
maxvel.t2 <- ResTTest(all.data$maxVEL[all.data$Individual=="LAUR02"],all.data$Strategy[all.data$Individual=="LAUR02"])
tmaxvel.t2 <- ResTTest(all.data$tmaxVEL[all.data$Individual=="LAUR02"],all.data$Strategy[all.data$Individual=="LAUR02"])
accpg.t2 <- ResTTest(all.data$ACCPG[all.data$Individual=="LAUR02"],all.data$Strategy[all.data$Individual=="LAUR02"])
ratio.t2 <- ResTTest(all.data$H_L_ratio[all.data$Individual=="LAUR02"],all.data$Strategy[all.data$Individual=="LAUR02"])
vol.t2 <- ResTTest(all.data$ingested_volume[all.data$Individual=="LAUR02"],all.data$Strategy[all.data$Individual=="LAUR02"])
ppd.t2 <- ResTTest(all.data$PPDiopen[all.data$Individual=="LAUR02"],all.data$Strategy[all.data$Individual=="LAUR02"])
time.t2 <- ResTTest(all.data$timeatcapture[all.data$Individual=="LAUR02"],all.data$Strategy[all.data$Individual=="LAUR02"])
ai.t2 <- ResTTest(all.data$AI[all.data$Individual=="LAUR02"],all.data$Strategy[all.data$Individual=="LAUR02"])

ttest2 <- data.frame(rbind(pg.t2,tto.t2,ttc.t2,pprot.t2,pprotvel.t2,tpprot.t2,velpg.t2,maxvel.t2,tmaxvel.t2,accpg.t2,ratio.t2,vol.t2,
                           time.t2,ai.t2))
ttest2$Individual <- "LAUR02"
ttest2$variable <- c("PG","TTO","TTC","PPROT","PPROTVEL","tPPROT","VELPG",
                     "maxVEL","tmaxVEL","ACCPG","H:L","volume",
                     "timeatcapture","AI")

pg.t3 <-  ResTTest(all.data$PG[all.data$Individual=="LAUR03"],all.data$Strategy[all.data$Individual=="LAUR03"])
tto.t3 <- ResTTest(all.data$TTO[all.data$Individual=="LAUR03"],all.data$Strategy[all.data$Individual=="LAUR03"])
ttc.t3 <- ResTTest(all.data$TTC[all.data$Individual=="LAUR03"],all.data$Strategy[all.data$Individual=="LAUR03"])
pprot.t3 <- ResTTest(all.data$PPROT[all.data$Individual=="LAUR03"],all.data$Strategy[all.data$Individual=="LAUR03"])
pprotvel.t3 <- ResTTest(all.data$PPROTVEL[all.data$Individual=="LAUR03"],all.data$Strategy[all.data$Individual=="LAUR03"])
tpprot.t3 <- ResTTest(all.data$tPPROT[all.data$Individual=="LAUR03"],all.data$Strategy[all.data$Individual=="LAUR03"])
velpg.t3 <- ResTTest(all.data$VELPG[all.data$Individual=="LAUR03"],all.data$Strategy[all.data$Individual=="LAUR03"])
maxvel.t3 <- ResTTest(all.data$maxVEL[all.data$Individual=="LAUR03"],all.data$Strategy[all.data$Individual=="LAUR03"])
tmaxvel.t3 <- ResTTest(all.data$tmaxVEL[all.data$Individual=="LAUR03"],all.data$Strategy[all.data$Individual=="LAUR03"])
accpg.t3 <- ResTTest(all.data$ACCPG[all.data$Individual=="LAUR03"],all.data$Strategy[all.data$Individual=="LAUR03"])
ratio.t3 <- ResTTest(all.data$H_L_ratio[all.data$Individual=="LAUR03"],all.data$Strategy[all.data$Individual=="LAUR03"])
vol.t3 <- ResTTest(all.data$ingested_volume[all.data$Individual=="LAUR03"],all.data$Strategy[all.data$Individual=="LAUR03"])
ppd.t3 <- ResTTest(all.data$PPDiopen[all.data$Individual=="LAUR03"],all.data$Strategy[all.data$Individual=="LAUR03"])
time.t3 <- ResTTest(all.data$timeatcapture[all.data$Individual=="LAUR03"],all.data$Strategy[all.data$Individual=="LAUR03"])
ai.t3 <- ResTTest(all.data$AI[all.data$Individual=="LAUR03"],all.data$Strategy[all.data$Individual=="LAUR03"])

ttest3 <- data.frame(rbind(pg.t3,tto.t3,ttc.t3,pprot.t3,pprotvel.t3,tpprot.t3,velpg.t3,maxvel.t3,tmaxvel.t3,accpg.t3,ratio.t3,vol.t3,ppd.t3,
                           time.t3,ai.t3))
ttest3$Individual <- "LAUR03"
ttest3$variable <- c("PG","TTO","TTC","PPROT","PPROTVEL","tPPROT","VELPG",
                     "maxVEL","tmaxVEL","ACCPG","H:L","volume","PPDiopen",
                     "timeatcapture","AI")


pg.t4 <-  ResTTest(all.data$PG[all.data$Individual=="LAUR04"],all.data$Strategy[all.data$Individual=="LAUR04"])
tto.t4 <- ResTTest(all.data$TTO[all.data$Individual=="LAUR04"],all.data$Strategy[all.data$Individual=="LAUR04"])
ttc.t4 <- ResTTest(all.data$TTC[all.data$Individual=="LAUR04"],all.data$Strategy[all.data$Individual=="LAUR04"])
pprot.t4 <- ResTTest(all.data$PPROT[all.data$Individual=="LAUR04"],all.data$Strategy[all.data$Individual=="LAUR04"])
pprotvel.t4 <- ResTTest(all.data$PPROTVEL[all.data$Individual=="LAUR04"],all.data$Strategy[all.data$Individual=="LAUR04"])
tpprot.t4 <- ResTTest(all.data$tPPROT[all.data$Individual=="LAUR04"],all.data$Strategy[all.data$Individual=="LAUR04"])
velpg.t4 <- ResTTest(all.data$VELPG[all.data$Individual=="LAUR04"],all.data$Strategy[all.data$Individual=="LAUR04"])
maxvel.t4 <- ResTTest(all.data$maxVEL[all.data$Individual=="LAUR04"],all.data$Strategy[all.data$Individual=="LAUR04"])
tmaxvel.t4 <- ResTTest(all.data$tmaxVEL[all.data$Individual=="LAUR04"],all.data$Strategy[all.data$Individual=="LAUR04"])
accpg.t4 <- ResTTest(all.data$ACCPG[all.data$Individual=="LAUR04"],all.data$Strategy[all.data$Individual=="LAUR04"])
ratio.t4 <- ResTTest(all.data$H_L_ratio[all.data$Individual=="LAUR04"],all.data$Strategy[all.data$Individual=="LAUR04"])
vol.t4 <- ResTTest(all.data$ingested_volume[all.data$Individual=="LAUR04"],all.data$Strategy[all.data$Individual=="LAUR04"])
ppd.t4 <- ResTTest(all.data$PPDiopen[all.data$Individual=="LAUR04"],all.data$Strategy[all.data$Individual=="LAUR04"])
time.t4 <- ResTTest(all.data$timeatcapture[all.data$Individual=="LAUR04"],all.data$Strategy[all.data$Individual=="LAUR04"])
ai.t4 <- ResTTest(all.data$AI[all.data$Individual=="LAUR04"],all.data$Strategy[all.data$Individual=="LAUR04"])

ttest4 <- data.frame(rbind(pg.t4,tto.t4,ttc.t4,pprot.t4,pprotvel.t4,tpprot.t4,velpg.t4,maxvel.t4,tmaxvel.t4,accpg.t4,ratio.t4,vol.t4,ppd.t4,
                           time.t4,ai.t4))
ttest4$Individual <- "LAUR04"
ttest4$variable <- c("PG","TTO","TTC","PPROT","PPROTVEL","tPPROT","VELPG",
                     "maxVEL","tmaxVEL","ACCPG","H:L","volume","PPDiopen",
                     "timeatcapture","AI")

pg.t5 <-  ResTTest(all.data$PG[all.data$Individual=="LAUR05"],all.data$Strategy[all.data$Individual=="LAUR05"])
tto.t5 <- ResTTest(all.data$TTO[all.data$Individual=="LAUR05"],all.data$Strategy[all.data$Individual=="LAUR05"])
ttc.t5 <- ResTTest(all.data$TTC[all.data$Individual=="LAUR05"],all.data$Strategy[all.data$Individual=="LAUR05"])
pprot.t5 <- ResTTest(all.data$PPROT[all.data$Individual=="LAUR05"],all.data$Strategy[all.data$Individual=="LAUR05"])
pprotvel.t5 <- ResTTest(all.data$PPROTVEL[all.data$Individual=="LAUR05"],all.data$Strategy[all.data$Individual=="LAUR05"])
tpprot.t5 <- ResTTest(all.data$tPPROT[all.data$Individual=="LAUR05"],all.data$Strategy[all.data$Individual=="LAUR05"])
velpg.t5 <- ResTTest(all.data$VELPG[all.data$Individual=="LAUR05"],all.data$Strategy[all.data$Individual=="LAUR05"])
maxvel.t5 <- ResTTest(all.data$maxVEL[all.data$Individual=="LAUR05"],all.data$Strategy[all.data$Individual=="LAUR05"])
tmaxvel.t5 <- ResTTest(all.data$tmaxVEL[all.data$Individual=="LAUR05"],all.data$Strategy[all.data$Individual=="LAUR05"])
accpg.t5 <- ResTTest(all.data$ACCPG[all.data$Individual=="LAUR05"],all.data$Strategy[all.data$Individual=="LAUR05"])
ratio.t5 <- ResTTest(all.data$H_L_ratio[all.data$Individual=="LAUR05"],all.data$Strategy[all.data$Individual=="LAUR05"])
vol.t5 <- ResTTest(all.data$ingested_volume[all.data$Individual=="LAUR05"],all.data$Strategy[all.data$Individual=="LAUR05"])
ppd.t5 <- ResTTest(all.data$PPDiopen[all.data$Individual=="LAUR05"],all.data$Strategy[all.data$Individual=="LAUR05"])
time.t5 <- ResTTest(all.data$timeatcapture[all.data$Individual=="LAUR05"],all.data$Strategy[all.data$Individual=="LAUR05"])
ai.t5 <- ResTTest(all.data$AI[all.data$Individual=="LAUR05"],all.data$Strategy[all.data$Individual=="LAUR05"])

ttest5 <- data.frame(rbind(pg.t5,tto.t5,ttc.t5,pprot.t5,pprotvel.t5,tpprot.t5,velpg.t5,maxvel.t5,tmaxvel.t5,accpg.t5,ratio.t5,vol.t5,ppd.t5,
                           time.t5,ai.t5))
ttest5$Individual <- "LAUR05"
ttest5$variable <- c("PG","TTO","TTC","PPROT","PPROTVEL","tPPROT","VELPG",
                     "maxVEL","tmaxVEL","ACCPG","H:L","volume","PPDiopen",
                     "timeatcapture","AI")
 # Put it all together 
ttest_ind <- data.frame(rbind(ttest1,ttest2,ttest3,ttest4,ttest5))

# Write to a csv file 
#NOTE: Rows are doubled because of CI calculations. Variables will also be doubled. 
# Each variable technically gets two rows 
write.csv(ttest_ind,"Ttest_stratxInd_Redbreast2022.csv")
